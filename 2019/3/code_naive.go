...
func parseNaive(str string) []Point {
	var result []Point
...
func findShortestPathNaive(a1, a2 []Point) int {
	intersections := findIntersections(a1, a2)
